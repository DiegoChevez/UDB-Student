...
public class AlumnoDatos {
    ...
    private final String SQL_UPDATE = "UPDATE alumno SET Cod_alumno=?, Nombre=?, Apellido=?, Edad=?, Direccion=? WHERE Cod_alumno=?";
    ...
    public int insert(AlumnoBeans alumnoBeans){
        ...
        try {
            ...
            stmt.setInt(index++, alumnoBeans.getCodAlumno());
